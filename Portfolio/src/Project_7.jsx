  ...
  return (
    <div className={style.project1}>
      ...
      <div className={style.project1child1}>
        <img
          src="https://res.cloudinary.com/dkotituzn/image/upload/v1713624654/shahabuddin/tiz1myvnpldzlq9uhx5b.png"
          alt=""
        />
      </div>
      <div className={style.project1child2}>
        <video
          src="https://res.cloudinary.com/dkotituzn/video/upload/v1714119319/shahabuddin/klwtqgve4mflxfigcrgo.mp4"
          controls
          muted
          autoPlay
        />
      ...
      >{`The platform integrates JWT and NextAuth for secure authentication, advanced filtering for precise product selection, and streamlined  `}</div>
      <div className={style.openandclose}>
        bidding, enhancing user experience and facilitating secure SSL Commerz
        payments.
      </div>
      ...
      <div className={style.anarduinoproject}>
        A bidding platform with Spring Boot and Next.js for post addition,
        product selection, bidding, and SSL Commerz-enabled payments.
      </div>
    </div>
  );
};
