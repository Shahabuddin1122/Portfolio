      ...
      <>
          ...
          <div className={style.book}>
                   ...
                   <div className={style.top}>
                    ...
                    <div className={style.down}>
                        <div className={style.header}>
                            <h2><span className={style.highlight}>Get Touch in</span></h2>
                        </div>
                    ...
                    <div className={style.label}>
                        <label htmlFor={style.checkboxmaincover} className={style.covernext}><p>Click to next</p></label>
                    </div>
                  </div>
                  <div className={style.back}>
                      <label htmlFor={style.checkboxmaincover} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.pages} id={style.page1}>
                  <div className={style.front}>
                      <Intro/>
                      <label htmlFor={style.checkboxpage1} className={style.next}><p>&gt;</p></label>
                  </div>
                  <div className={style.back}>
                      <Education/>
                      <label htmlFor={style.checkboxpage1} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.pages} id={style.page2}>
                  <div className={style.front}>
                      <Table/>
                      <label htmlFor={style.checkboxpage2} className={style.next}><p>&gt;</p></label>
                  </div>
                  <div className={style.back}>
                      <Project1/>
                      <label htmlFor={style.checkboxpage2} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.pages} id={style.page3}>
                  <div className={style.front}>
                      <Project2/>
                      <label htmlFor={style.checkboxpage3} className={style.next}><p>&gt;</p></label>
                  </div>
                  <div className={style.back}>
                      <Project3/>
                      <label htmlFor={style.checkboxpage3} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.pages} id={style.page4}>
                  <div className={style.front}>
                      <Project4/>
                      <label htmlFor={style.checkboxpage4} className={style.next}><p>&gt;</p></label>
                  </div>
                  <div className={style.back}>
                      <Project5/>
                      <label htmlFor={style.checkboxpage4} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.pages} id={style.page5}>
                  ...
                  <div className={style.back}>
                      <label htmlFor={style.checkboxpage5} className={style.prev}><p>&lt;</p></label>
                  </div>
              </div>
              <div className={style.backcover} >
                    <label htmlFor={style.checkboxbackcover} className={style.covernext}/>
              </div>
          </div>
      </>
