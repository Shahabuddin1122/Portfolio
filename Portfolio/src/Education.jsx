...
const Education = () => {
  return (
    <div className={style.education}>
      <div className={style.educationchild} />
      <div className={style.education1}>{`Education `}</div>
      ...
      <img className={style.educationchild2} alt="" src="https://res.cloudinary.com/dkotituzn/image/upload/v1702596427/shahabuddin/gns1zbnjujuodlsjk5ry.svg" />
      <div className={style.educationchild3} />
      <img className={style.educationchild4} alt="" src="https://res.cloudinary.com/dkotituzn/image/upload/v1702596427/shahabuddin/eifxuzjsvnw3g2cuis7j.svg" />
      <img className={style.educationchild5} alt="" src="https://res.cloudinary.com/dkotituzn/image/upload/v1702596427/shahabuddin/gns1zbnjujuodlsjk5ry.svg" />
      <div className={style.educationchild6} />
      <div className={style.ipassedmycontainer}>
        <p className={style.ipassedmy}>I passed my SSC from</p>
        <p className={style.ipassedmy}>A.K High School in 2018 with GPA 5.0.</p>
      </div>
      <div className={style.ipassedmycontainer1}>
        <p className={style.ipassedmy}>I passed my HSC from</p>
        <p className={style.ipassedmy}>
          Dr. Mahbubur Rahman Mollah Collage in 2020 with GPA 5.0.
        </p>
      </div>
        
      <div className={style.ipassedmycontainer2}>
        <p className={style.ipassedmy}>I passed my BSc from</p>
        <p className={style.ipassedmy}>
      ...
      <div className={style.sql}>SQL</div>
      <div className={style.educationchild19} />
    </div>
  );
};
